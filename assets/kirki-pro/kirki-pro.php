...
if ( ! function_exists( 'kirki_pro_init_controls' ) ) {
	...
	function kirki_pro_init_controls() {
		...
		$packages = [
			'mapsteps/control-headline-divider',
			'mapsteps/control-input-slider',
			'mapsteps/control-margin-padding',
			'mapsteps/control-responsive',
			'mapsteps/control-tab',
		];

		foreach ( $packages as $package ) {
			$init_class_name = str_ireplace( 'mapsteps/control-', '', $package );
