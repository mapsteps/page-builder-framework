(function($) {
	...
	function MobileToggle() {
		...
		if(mobileToggle.hasClass("active")) {
			...
			mobileToggle.removeClass("active").removeClass('wpbff-times').addClass('wpbff-hamburger').attr( 'aria-expanded', 'false' );
		} else {
			$('.wpbf-mobile-menu-container').addClass('active').slideDown();
			mobileToggle.addClass("active").removeClass('wpbff-hamburger').addClass('wpbff-times').attr( 'aria-expanded', 'true' );
