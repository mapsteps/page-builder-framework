...
$section_id = 'wpbf_header_builder_desktop_button_2_section';

wpbf_customizer_section()
	->id( $section_id )
	->type( 'invisible' )
	->title( __( 'Button 2', 'page-builder-framework' ) )
	->tabs( [
		'general' => [
...
$control_id_prefix = 'wpbf_header_builder_desktop_button_2_';

$partial_refresh_key_prefix = 'headerbuilder_desktop_button_2_';
