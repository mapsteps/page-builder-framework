...
wpbf_customizer_field()
	...
	// Icon color.
wpbf_customizer_field()
	->id( $control_id_prefix . 'mobile_menu_hamburger_color' )
	->type( 'color' )
	->tab( 'design' )
...
// Hamburger size.
wpbf_customizer_field()
	->id( $control_id_prefix . 'mobile_menu_hamburger_size' )
	->type( 'input-slider' )
	->tab( 'design' )
...
wpbf_customizer_field()
	->id( $control_id_prefix . 'mobile_menu_hamburger_bg_color' )
	->type( 'color' )
	->tab( 'design' )
...
// Border radius.
wpbf_customizer_field()
	->id( $control_id_prefix . 'mobile_menu_hamburger_border_radius' )
	->type( 'slider' )
	->tab( 'design' )
