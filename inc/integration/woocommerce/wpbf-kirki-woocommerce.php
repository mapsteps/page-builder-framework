...
// Menu item.
Kirki::add_section(
	'wpbf_woocommerce_menu_item_options',
	array(
...
// Product page.
Kirki::add_section(
	'wpbf_woocommerce_product_options',
	array(
...
// Sidebar.
Kirki::add_section(
	'wpbf_woocommerce_sidebar_options',
	array(
...
// Notices.
Kirki::add_section(
	'wpbf_woocommerce_notices_options',
	array(
...
function wpbf_woo_custom_controls_default( $wp_customize ) {
	$wp_customize->add_setting(
		'woocommerce_loop_products_per_row_desktop',
		array(
			'default'           => '4',
	...
	$wp_customize->add_setting(
		'woocommerce_loop_products_per_row_tablet',
		array(
			'default'           => '2',
			'sanitize_callback' => 'absint',
		)
	...
	$wp_customize->add_setting(
		'woocommerce_loop_products_per_row_mobile',
		array(
			'sanitize_callback' => 'absint',
		)
	);
	...
	$wp_customize->add_control(
		new WPBF_Customize_Font_Size_Control(
			$wp_customize,
