...
if ( has_custom_logo() ) {
	...
	$custom_logo_url  = apply_filters( 'wpbf_logo_mobile', ( $custom_logo_data ? $custom_logo_data[0] : '' ) );
	$custom_logo_type = wp_check_filetype( $custom_logo_url );

	if ( $custom_logo_data && $custom_logo_data[0] !== $custom_logo_url ) {
	...
	$custom_logo_width  = $custom_logo_data ? $custom_logo_data[1] : '';
	$custom_logo_height = $custom_logo_data ? $custom_logo_data[2] : '';
	$dimensions         = 'svg' === $custom_logo_type['ext'] ? '' : ' width="' . esc_attr( $custom_logo_width ) . '" height="' . esc_attr( $custom_logo_height ) . '"';
