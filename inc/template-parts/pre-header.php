...
$pre_header_column_one = get_theme_mod( 'pre_header_column_one' );
$pre_header_column_two = get_theme_mod( 'pre_header_column_two' );

if ( ! empty( $pre_header_layout ) && $pre_header_layout !== 'none' ) {
