...
function wpbf_search_menu_item( $is_navigation = true, $is_mobile = false ) {
	...
	$search_item .= $is_navigation ? '<li class="menu-item wpbf-menu-item-search" aria-haspopup="true" aria-expanded="false"><a href="javascript:void(0)" role="button">' : '<button class="'. $class .' wpbf-menu-item-search" aria-haspopup="true" aria-expanded="false" role="button">';
